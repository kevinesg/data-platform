...
| `deploy-qa` | [deploy-qa.yml](deploy-qa.yml) | Manual dispatch | Deploys the selected Git ref with the latest matching immutable data-platform images and the immutable private ETL image resolved from its QA candidate pointer. |
